...
public class Picture extends SimplePicture 
{
  ...
  public void mirrorArms()
  {
    ...
    // loop through the rows
    for (int row = 168; row < 199; row++)
    {
      // loop from 13 to just before the mirror point
      for (int col = 245; col < 294; col++)
      {
  ...
  public void shiftGull(){
      ...
      {
          // loop from 13 to just before the mirror point
          for (int col = 218; col < shiftAxis; col++)
          {
              leftPixel = pixels[row][col];
              rightPixel = pixels[row][132 + col];
              rightPixel.setColor(leftPixel.getColor());
          }
      }
  ...
  public void createCollage2()
  {
    Picture flower1 = new Picture("flower1.jpg");
    Picture flower2 = new Picture("flower2.jpg");
    this.copy2(flower1,0,0,10,20);
    this.copy2(flower2,100,0,10,20);
    this.copy2(flower1,200,0,10,20);
    Picture flowerNoBlue = new Picture(flower2);
    flowerNoBlue.zeroBlue();
    this.copy2(flowerNoBlue,300,0,80,90);
    this.copy2(flower1,400,0,80,90);
    this.copy2(flower2,500,0,80,90);
    this.mirrorVertical();
    this.write("collage.jpg");
  }
